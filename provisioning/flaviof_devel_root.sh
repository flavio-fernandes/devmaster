...
dnf install -y tmux wget emacs-nox vim tmate bat pip dnsutils cronie ripgrep fzf mosh
...
## https://github.com/ovn-org/ovn-kubernetes/pull/3749#discussion_r1497791405
