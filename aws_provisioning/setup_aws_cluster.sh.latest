...
CI_VER=$(curl -vs https://openshift-release.apps.ci.l2s4.p1.openshiftapps.com/  2>&1 | grep "<a class=\"text-success\" href=\"/releasestream/4.14.0-0.ci/release/" -m1 | pup 'a text{}')
